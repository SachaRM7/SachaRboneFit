...
export async function proxy(request: NextRequest) {
  ...
  if (url.pathname.startsWith('/dashboard') || url.pathname.startsWith('/sessions') ||
      ...
      url.pathname.startsWith('/profil') || url.pathname.startsWith('/historique') || url.pathname.startsWith('/programme') ||
      url.pathname.startsWith('/session') || url.pathname.startsWith('/bienvenue')) {
    if (!user) {
      url.pathname = '/login';
