...
export function tempsDepasse(
  ...
  return {
    ...
    message: coupes.length > 0
      ...
      : "Temps encore超出, mais pas d'autres coupes possibles sans retirer les piliers.",
  };
}